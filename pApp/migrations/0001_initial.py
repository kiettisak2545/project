# Generated by Django 5.1.5 on 2025-01-26 16:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depositslip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deposit_orders', to='pApp.depositslip')),
            ],
        ),
        migrations.CreateModel(
            name='order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slips', to='pApp.depositslip')),
            ],
        ),
    ]
